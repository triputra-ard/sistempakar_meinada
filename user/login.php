    ...
    <div class="container">
      <center>
        ...
        <div class="panel-body">
          ...
          <div class="col-lg-3">
            <div class="form-example-wrap animated flipInY">
              <img src="../assets/img/ico_kerusakan_hp.png" alt="" width="240px" height="240px">
            </div>
          </div>
      ...
      <div class="panel transparent-total">
        <div class="panel-body">
          <div class="col-lg-4"></div>
          <div class="col-lg-3">
              <div class="form-example-wrap animated rotateInDownLeft">
