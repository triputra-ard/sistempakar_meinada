    ...
    <div class="col-lg-col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4>Tambah Data Relasi Software</h4>
        </div>
        <div class="panel-body">
          <form method="post" action="control/soft.tambah?relasi">
          <div class="row">
              <div class="col-lg-2">
              ...
              <div class="col-lg-2">
                <div class="form-group">
                  <div class="nk-int-st">
                    <input readonly class="form-control" type="text" name="id" value="<?php echo autokode("relasi_gejala_sf", "REL-SF"); ?>">
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="data-table-area">
      <div class="col-lg-col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="data-table-list">
          ...
          <?php include 'view/sf.relasi.view.php'; ?>
        </div>
        </div>
      </div>
    </div>
