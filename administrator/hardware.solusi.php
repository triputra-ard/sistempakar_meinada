      ...
      <div class="col-lg-col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h4>Tambah Data Solusi Hardware</h4>
          </div>
          <div class="panel-body">
            <form class="" action="control/hard.tambah?solusi" method="post">
              <div class="row">
                <div class="col-lg-2">
                ...
                <div class="col-lg-2">
                  <div class="form-group">
                    <div class="nk-int-st">
                      <input readonly class="form-control" type="text" name="id" value="<?php echo autokode("hd_solusi", "S-HD"); ?>">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    <div class="nk-int-st">
                      <textarea placeholder="Tambahkan Deskripsi" name="deskripsi_hd" rows="8" cols="80"></textarea>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="col-lg-col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="data-table-list">
            <div class="basic-tb-hd">
              <h4>Data Solusi Hardware</h4><hr>
            </div>
            <div class="table-responsive">
            <?php include 'view/hd.solusi.view.php'; ?>
          </div>
          </div>
        </div>
